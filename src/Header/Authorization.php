 ...
 */
class Authorization implements Header_Interface
{
    /** @var string */
    protected $value;
    /**
    ...
    public static function from_string($header_line): static
    {
        ...
        if (strtolower($name) !== 'authorization') {
            throw new Exception\InvalidArgumentException(sprintf('Invalid header line for Authorization string: "%s"', $name));
        }
    ...
    {
        return 'Authorization: ' . $this->get_field_value();
    }
}