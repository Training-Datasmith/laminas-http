 ...
 */
class Content_Range implements Header_Interface
{
    /** @var string */
    protected $value;
    /**
    ...
    public static function from_string($header_line): static
    {
        ...
        if (strtolower($name) !== 'content-range') {
            throw new Exception\InvalidArgumentException(sprintf('Invalid header line for Content-Range string: "%s"', $name));
        }
    ...
    {
        return 'Content-Range: ' . $this->get_field_value();
    }
}